...
$(ObjDir)/SampleDatasetMLPTest.cpp_pre.cpp.tb.o : SampleDatasetMLPTest.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling SampleDatasetMLPTest.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/SampleDatasetMLP.cpp_pre.cpp.tb.o : SampleDatasetMLP.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling SampleDatasetMLP.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
