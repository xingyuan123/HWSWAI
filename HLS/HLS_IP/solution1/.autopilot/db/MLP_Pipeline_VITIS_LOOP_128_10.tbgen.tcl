set moduleName MLP_Pipeline_VITIS_LOOP_128_10
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {MLP_Pipeline_VITIS_LOOP_128_10}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_layer_casted int 32 regular {array 5 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "output_layer_casted", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ out_data_TREADY sc_in sc_logic 1 outacc 6 } 
	{ output_layer_casted_address0 sc_out sc_lv 3 signal 0 } 
	{ output_layer_casted_ce0 sc_out sc_logic 1 signal 0 } 
	{ output_layer_casted_q0 sc_in sc_lv 32 signal 0 } 
	{ tmp_keep_V_reload sc_in sc_lv 4 signal 1 } 
	{ tmp_strb_V_reload sc_in sc_lv 4 signal 2 } 
	{ tmp_user_V_reload sc_in sc_lv 2 signal 3 } 
	{ tmp_id_V_reload sc_in sc_lv 5 signal 4 } 
	{ tmp_dest_V_reload sc_in sc_lv 6 signal 5 } 
	{ out_data_TDATA sc_out sc_lv 32 signal 6 } 
	{ out_data_TVALID sc_out sc_logic 1 outvld 12 } 
	{ out_data_TKEEP sc_out sc_lv 4 signal 7 } 
	{ out_data_TSTRB sc_out sc_lv 4 signal 8 } 
	{ out_data_TUSER sc_out sc_lv 2 signal 9 } 
	{ out_data_TLAST sc_out sc_lv 1 signal 10 } 
	{ out_data_TID sc_out sc_lv 5 signal 11 } 
	{ out_data_TDEST sc_out sc_lv 6 signal 12 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_data_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "out_data_V_data_V", "role": "default" }} , 
 	...
 	{ "name": "output_layer_casted_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "output_layer_casted", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	output_layer_casted { ap_memory {  { output_layer_casted_address0 mem_address 1 3 }  { output_layer_casted_ce0 mem_ce 1 1 }  { output_layer_casted_q0 in_data 0 32 } } }
	...
	out_data_V_data_V { axis {  { out_data_TREADY out_acc 0 1 }  { out_data_TDATA out_data 1 32 } } }
	...
	out_data_V_dest_V { axis {  { out_data_TVALID out_vld 1 1 }  { out_data_TDEST out_data 1 6 } } }
}
