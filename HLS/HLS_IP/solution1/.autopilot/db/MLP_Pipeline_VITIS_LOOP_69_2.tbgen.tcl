set moduleName MLP_Pipeline_VITIS_LOOP_69_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {MLP_Pipeline_VITIS_LOOP_69_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_features int 32 regular {array 48 { 1 3 } 1 1 }  }
	{ input_features_casted float 32 regular {array 48 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_features", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ input_features_address0 sc_out sc_lv 6 signal 0 } 
	{ input_features_ce0 sc_out sc_logic 1 signal 0 } 
	{ input_features_q0 sc_in sc_lv 32 signal 0 } 
	{ input_features_casted_address0 sc_out sc_lv 6 signal 1 } 
	{ input_features_casted_ce0 sc_out sc_logic 1 signal 1 } 
	{ input_features_casted_we0 sc_out sc_logic 1 signal 1 } 
	{ input_features_casted_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_features_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "input_features", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fptrunc_64ns_32_2_no_dsp_1_U20", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddiv_64ns_64ns_64_22_no_dsp_1_U21", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitodp_32ns_64_4_no_dsp_1_U22", "Parent" : "0"},
...
set Spec2ImplPortList { 
	input_features { ap_memory {  { input_features_address0 mem_address 1 6 }  { input_features_ce0 mem_ce 1 1 }  { input_features_q0 in_data 0 32 } } }
