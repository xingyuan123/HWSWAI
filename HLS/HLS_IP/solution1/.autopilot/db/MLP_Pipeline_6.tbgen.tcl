...
set hasInterrupt 0
set C_modelName {MLP_Pipeline_6}
...
set portList { 
	...
	{ output_layer_casted_we0 sc_out sc_logic 1 signal 0 } 
	{ output_layer_casted_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
