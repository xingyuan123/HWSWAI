...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 380 \
    name output_layer_casted \
    reset_level 1 \
    sync_rst true \
    dir I \
    corename output_layer_casted \
    op interface \
    ports { output_layer_casted_address0 { O 3 vector } output_layer_casted_ce0 { O 1 bit } output_layer_casted_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'output_layer_casted'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_data_TREADY { I 1 bit } out_data_TDATA { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_data_TUSER { O 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_data_TVALID { O 1 bit } out_data_TDEST { O 6 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { tmp_keep_V_reload { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { tmp_strb_V_reload { I 4 vector } } \
} "
}
